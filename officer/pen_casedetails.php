...
<div class="container-fluid">
	...
	<div class="col-md-8">
		...
		<a href="addcompl.php?id=<?php echo $get_id; ?>"  class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> Approve</a>

		<a href="pen_case.php?rid=<?php echo $get_id; ?>"  class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> Reject</a>
